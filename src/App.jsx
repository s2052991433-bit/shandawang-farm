...
const products = [
  { id: "bayberry", name: "东魁杨梅 · 山选大果", desc: "当季现摘，酸甜多汁", price: 128, unit: "2斤装", tag: "本季限定", category: "当季", image: asset("bayberries.webp") },
  { id: "eggs", name: "山林散养鸡蛋", desc: "谷物喂养，营养鲜味", price: 68, unit: "30枚", tag: "农场自产", category: "农场自产", image: asset("eggs.webp") },
  { id: "peaches", name: "水蜜桃 · 湖景基地", desc: "香甜多汁，现摘现发", price: 98, unit: "4斤装", tag: "本周鲜选", category: "当季", image: asset("peaches.webp") },
  { id: "gift", name: "山大王四季礼盒", desc: "精选组合，送礼佳品", price: 298, unit: "1盒", tag: "礼赠甄选", category: "礼盒", image: asset("gift-box.webp") },
];
...
function Home({ navigate, addToCart }) {
  return <>
    <section className="hero"><img src={asset("hero-farm.webp")} alt="晨光中的山大王农场与远山" /><div className="hero-shade" />
      ...
      <aside className="farm-now-card"><div className="farm-card-head"><div><strong>今日农场</strong><span>8月24日 · 晴 26°C</span></div><Clock size={22} /></div>
        <div className="farm-update"><img src={asset("bayberries.webp")} alt="杨梅" /><span><b>杨梅进入最佳采摘期</b><small>果实饱满，酸甜多汁</small></span></div>
        <div className="farm-update"><img src={asset("eggs.webp")} alt="鲜鸡蛋" /><span><b>鸡舍今日新鲜收集</b><small>山林散养，营养好蛋</small></span></div>
        <div className="farm-update"><img src={asset("peaches.webp")} alt="桃子" /><span><b>新一批水蜜桃在成熟</b><small>自然生长，安心慢熟</small></span></div>
      </aside>
    </section>
    ...
    <section className="proof-section"><div className="section-shell"><div className="section-heading compact"><div><h2>为什么是这些东西</h2><p>因为它们来自真实的山里</p></div></div><div className="proof-grid">
      <article className="proof-card"><img src={asset("eggs.webp")} alt="山林散养" /><div><strong>山林散养</strong><span>自由活动，健康成长</span></div></article>
      <article className="proof-card"><img src={asset("bayberries.webp")} alt="当季采摘" /><div><strong>当季采摘</strong><span>自然成熟，及时采摘</span></div></article>
      <article className="proof-card"><img src={asset("hero-farm.webp")} alt="农场山野" /><div><strong>天然种植</strong><span>不催熟，少干预</span></div></article>
...
function Farm({ navigate }) {
  return <main><section className="farm-hero"><img src={asset("hero-farm.webp")} alt="山大王农场全景" /><div className="farm-hero-copy"><span className="eyebrow light">农场此刻 · 八月</span><h1>土地有自己的时间</h1><p>我们记录每一次开花、成熟与采收，也把它们变成你能安心带回家的味道。</p></div></section><section className="page-shell farm-content"><div className="season-header"><div><span className="eyebrow">今天的山里</span><h2>正在发生的三件小事</h2></div><span className="date-chip">8 月 24 日 · 晴</span></div><div className="timeline-cards"><article><img src={asset("bayberries.webp")} alt="杨梅采摘" /><div><span>08:10 · 东坡果园</span><h3>杨梅进入最后一周采摘</h3><p>清晨露水散去后开始采摘，成熟果当天完成分选。</p></div></article><article><img src={asset("eggs.webp")} alt="收集鸡蛋" /><div><span>09:30 · 山林鸡舍</span><h3>今日新鲜鸡蛋完成收集</h3><p>按大小分级、逐枚灯检，傍晚前进入包装区。</p></div></article><article><img src={asset("peaches.webp")} alt="桃子成熟" /><div><span>15:40 · 湖景基地</span><h3>下一批水蜜桃还要等三天</h3><p>让果实在枝头多待一点时间，风味会更完整。</p></div></article></div><section className="next-season"><div><span className="eyebrow light">即将成熟</span><h2>九月，新米与秋梨</h2><p>订阅农场提醒，第一批采收时我们会告诉你。</p><button className="ghost-button"><Bell size={18} /> 提醒我</button></div></section><div className="farm-shop-cta"><div><h2>农场正在发生什么，<br />商店就会出现什么。</h2><p>看看本周仍在采收的产品。</p></div><button className="primary-button" onClick={() => navigate("shop")}>看看当季 <ArrowRight size={17} /></button></div></section></main>;
}
