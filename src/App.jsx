...
import { FarmHeroMedia } from "./components/FarmHeroMedia";
...
function ImmersiveHero({ variant, now, navigate }) {
  ...
  return (
    <section className={`hero hero-${variant}`} aria-labelledby="hero-title">
      {variant === "home" ? <FarmHeroMedia /> : <img className="hero-image" src="/assets/hero-farm-v2.webp" alt="群山环抱、晨光中的山大王农场全景" />}
