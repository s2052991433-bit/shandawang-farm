...
- Automatic seasons, solar terms, lunar dates and log dates follow Asia/Shanghai. Weather data must be labeled as a regional forecast, with a clear unavailable state on failure. Exact farm coordinates have not been supplied; the default location is explicitly Ningbo city, not the farm. Cloudflare production weather access was verified on 2026-09-20; local preview requests may still fail independently. Manual demo controls must never imply live conditions. Preserve pause, reduced-motion and offscreen suspension. Hen movement is a bounded local photographic deformation, not skeletal animation, walking, or video footage.
