...
- The user rejected the first imperceptible mist overlay and the gloomy bamboo/pond experiment. Both are retired. The accepted image is currently implemented as a still; ongoing realistic natural animation is requested but has not been implemented or accepted. Do not equate the still-image approval with motion approval.
